...
const accountSeeder = async () => {
  ...
  await Account.insertMany([
    {
      username: 'minh.nn183592@sis.hust.edu.vn',
      password: '$argon2i$v=19$m=4096,t=3,p=1$SkxHdHRGYk1pQzNFTWxHWQ$LUWXr24knpusXx+2Cq1t7D/X84YbIvcv40mmJjTwbLg',
      role: 'student',
    },
    {
      username: 'minh.nn@gmail.com',
      password: '$argon2i$v=19$m=4096,t=3,p=1$SkxHdHRGYk1pQzNFTWxHWQ$LUWXr24knpusXx+2Cq1t7D/X84YbIvcv40mmJjTwbLg',
      role: 'admin',
    },
  ])
